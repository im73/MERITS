...
from models.models import MERITS_M
...
def main():
    ...
    # build the model
    model = MERITS_M(lab_dim=len(data[1][0]), med_dim=len(data[0][3][0]), ehr_adj=ehr_adj, ddi_adj=ddi_adj,
                   glu_encoder=vae, time_adj = time_adj,emb_dim=64, device=device, ddi_in_memory=DDI_IN_MEM, glu_dim = 64)
